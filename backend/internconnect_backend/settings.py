"""
Django settings for internconnect_backend project.
...
SECRET_KEY = 'django-insecure-nh^0a_67ouv-udm-w_ch=1-4bacai=ri3l%=%(+!w6n=-r@$)n'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Serve static files in container
...
ROOT_URLCONF = 'internconnect_backend.urls'
...
WSGI_APPLICATION = 'internconnect_backend.wsgi.application'


# Database
# Uses PostgreSQL when DB_HOST env var is set (Docker/Kubernetes),
# otherwise falls back to SQLite for local development.
if os.getenv('DB_HOST'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('DB_NAME', 'internconnect_db'),
            'USER': os.getenv('DB_USER', 'internconnect_user'),
